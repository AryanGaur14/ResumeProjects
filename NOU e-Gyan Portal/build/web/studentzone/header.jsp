            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav mx-5 me-0">
                        <li class="nav-item">
                            <a class="nav-link text-light" style="font-size: 1.5rem;" href="studenthome.jsp"><i class="bi bi-book-half"></i>Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light" style="font-size: 1.5rem;" href="studymaterial.jsp"><i class="bi bi-book-half"></i>Study Material</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light" style="font-size: 1.5rem;" href="assignment.jsp"><i class="bi bi-textarea-t"></i> Assignment</a></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light" style="font-size: 1.5rem;" href="postquestion.jsp"><i class="bi bi-mortarboard-fill"></i> Discussion Forum </a></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light" style="font-size:1.5rem;" href="response.jsp"><i class="bi bi-book-half"></i> Response</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light" style="font-size:1.5rem;" href="changepassword.jsp"><i class="bi bi-book-half"></i>Change Password</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light" style="font-size: 1.5rem;" href="logout.jsp"><i class="bi bi-book-half"></i> Logout</a>
                        </li>
                    </ul>
                </div>
            </div>
