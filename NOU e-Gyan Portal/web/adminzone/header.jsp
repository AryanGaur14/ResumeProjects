...
<div class="row col-sm-12" style="background-color: #780D0D">
    <div class="col-sm-11 px-3 mx-auto">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav mx-5 me-0">
                        <li class="nav-item">
                            <a class="nav-link text-light" style="font-size: 1.0rem;" href="adminhome.jsp"><i class="bi bi-book-half"></i>Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light" style="font-size: 1.0rem;" href="studentinfo.jsp"><i class="bi bi-book-half"></i>Student Management</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light" style="font-size: 1.0rem;" href="enquirymgmt.jsp"><i class="bi bi-textarea-t"></i> Enquiry Management</a></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light" style="font-size: 1.0rem;" href="feedbackmgmt.jsp"><i class="bi bi-mortarboard-fill"></i> Feedback Management </a></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light" style="font-size:1.0rem;" href="complainmgmt.jsp"><i class="bi bi-book-half"></i> Complain Management</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light" style="font-size:1.0rem;" href="uploadmaterial.jsp"><i class="bi bi-book-half"></i>Study Material Management</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light" style="font-size: 1.0rem;" href="changepassword.jsp"><i class="bi bi-book-half"></i>Change Password</a>
                        </li>
                         <li class="nav-item">
                            <a class="nav-link text-light" style="font-size: 1.0rem;" href="logout.jsp"><i class="bi bi-book-half"></i>Logout</a>
                        </li>
                    </ul>
                </div>
            </div>
